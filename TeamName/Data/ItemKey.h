...
// 
// 만약 특정 상황에서 아이템을 추가한다면 이 헤더파일을 추가하신 뒤, Inventory::AddItem(ItemKey::Health_Potion_Common, 1)처럼 사용할 수 있습니다. (삭제도 동일합니다.)
// 데이터 시트에 아이템을 추가할 때마다 Key의 이름을 작성해야 합니다.
// 변수 이름과 값은 동일한 이름으로 작성하는 것이 좋습니다.
// 즉, 데이터 시트의 Key, 변수 이름, 값은 모두 동일한 게 좋습니다.
namespace ItemKey
{
	const char* Health_Potion_Common = "Health_Potion_Common";
